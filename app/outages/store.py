...
(ADR-100): адрес не несёт смысла для векторного сходства, а пересказ списка из
...
коде и не записываемая ничем. Таблица появится тогда, когда
...
class OutageStore:
    ...
    def find(
        ...
        *,
        ...
        (ADR-100): выбор без основания хуже, потому что не виден.
