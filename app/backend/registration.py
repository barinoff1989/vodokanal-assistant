...
написаны агенты `form` и `draft_validator`.
"""
...
class Registrar:
    ...
    :param adapter: адаптер записи. `None` — регистрация выключена.
