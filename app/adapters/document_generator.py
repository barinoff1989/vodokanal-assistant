...
Путь документа целиком (раздел 41.4, закрытая находка F4)::
...
> не заданы ни одним документом (пункт 19 сведённого TODO). Взято S3/MinIO как
