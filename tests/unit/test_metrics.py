...
def test_все_метрики_дашборда_объявлены_кодом():
    """Отсутствие любой означает пустой виджет в бою.
...
def test_блокировки_считаются_с_причиной():
    """Дашборд: утечка вынесена в отдельный виджет и не смешана с общим счётчиком."""
...
def test_границы_гистограмм_стоят_вокруг_целей_готовности():
    ...
    Цели: время до первого куска 500 мс, полный ответ 3 секунды.
    """
