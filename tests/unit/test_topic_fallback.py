...
модели эмбеддингов. Отдельный `live`-тест проверяет числа (раздел 92 журнала)
...
# --- живой эмбеддер: проверка чисел раздела 92 (тяжёлый, только с --live) --- #


@pytest.mark.live
async def test_реальные_случаи_сессии_живой_эмбеддер():
    """Два целевых случая — раздела 90 и разбора «подключения» — обязаны
    ...
    # Раздел 93 журнала: «подключить» и «включат» — общий корень, эмбеддер
