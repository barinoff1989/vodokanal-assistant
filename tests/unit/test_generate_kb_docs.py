...
def test_нормативные_ссылки_только_наблюдавшиеся():
    ...
    недостоверные цифры в чужих черновиках (журнал, раздел 26.4).
    ...
    **Чего она не ловит, и это её граница:** пополнение самого `OBSERVED_REFS`.
    ...
    сдвигается заглушка, подставленная на место проверяемого (журнал, раздел
    69.3). Перечень охраняется не проверкой, а происхождением: в нём только
