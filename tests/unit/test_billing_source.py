...
требование проекта: «каждый лицевой счёт в начислениях
...
# --- связность данных (требование проекта) ------------------------------------ #
...
def test_начисления_привязаны_к_существующим_счетам():
    """Прямое требование проекта: «каждый лицевой счёт в начислениях
    существует в списке счетов».
...
def test_город_в_адресах_воронеж():
    """Прототип обслуживает один филиал.
