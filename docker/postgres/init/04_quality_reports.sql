...
--
-- ЧТО ЭТА ТАБЛИЦА ЕСТЬ. `quality_report` раздела 35.1: итог оценки судьёй
-- (faithfulness, answer_relevancy — раздел 36.1) пишется рядом с телеметрией
...
-- причиной, а не отсутствие записи (ADR-007, «Подтверждение», п. 9).
--
...
CREATE TABLE IF NOT EXISTS quality_reports (
    ...
    -- Доля ответов, прошедших ОБА стартовых порога раздела 36.1, [0, 1].
